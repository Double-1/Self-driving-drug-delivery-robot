...
#ifndef __AI_FACERECOGNITION_H__
#define __AI_FACERECOGNITION_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_FACERECOGNITION_MODEL_NAME          "facerecognition"

#define AI_FACERECOGNITION_ACTIVATIONS_ALIGNMENT   (4)

#define AI_FACERECOGNITION_IN_NUM       (1)
#define AI_FACERECOGNITION_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 96, 96, 3, 1, NULL), \
}
#define AI_FACERECOGNITION_IN_SIZE { \
  (96 * 96 * 3), \
}
#define AI_FACERECOGNITION_IN_1_SIZE  (96 * 96 * 3)
#define AI_FACERECOGNITION_IN_1_SIZE_BYTES  ((96 * 96 * 3) * 4)





#define AI_FACERECOGNITION_OUT_NUM      (1)
#define AI_FACERECOGNITION_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
}
#define AI_FACERECOGNITION_OUT_SIZE { \
  (1 * 1 * 2), \
}
#define AI_FACERECOGNITION_OUT_1_SIZE  (1 * 1 * 2)
#define AI_FACERECOGNITION_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 4)

#define AI_FACERECOGNITION_N_NODES (4)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup facerecognition
 ...
 * @ref ai_facerecognition_create. Both the activations memory buffer 
 ...
 * using @ref ai_facerecognition_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_FACERECOGNITION_*
 * defines into file @ref facerecognition.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_facerecognition_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_FACERECOGNITION_H__*/
